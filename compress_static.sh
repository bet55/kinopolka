...
#
# Использование:
#   ./compress_static.sh                          # темы (по умолчанию), все форматы
#   ./compress_static.sh static/img/tarots png     # только png в указанной папке
#   ./compress_static.sh static/img/carousel png   #
#
