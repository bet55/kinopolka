...
urlpatterns = [
    ...
    path(
        "cocktails/<int:pk>/availability/",
        CocktailAvailability.as_view(),
        name="cocktail-availability",
    ),
    path(
        "ingredients/telegram/",
        IngredientTelegramRequest.as_view(),
        name="ingredients-tg-request",
    ),
]
